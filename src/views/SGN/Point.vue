...
import boxtitle from "@/components/SIGNATURE/BoxTitle.vue";
import boxachievement from "@/components/SIGNATURE/BoxAchievement.vue";
import boxdetailpoint from "@/components/SIGNATURE/BoxDetailPoint.vue";
import boxrebate from "@/components/SIGNATURE/BoxRebate.vue";
import ButtonPromosi from "@/components/SIGNATURE/ButtonPromosi.vue";
import ButtonCatalog from "@/components/SIGNATURE/ButtonCatalog.vue";
...
export default {
  ...
  mounted() {
    axios
      .get(
        "http://www.inosis.co.id/mvsignature2020_api/api.php/dashboard-outlet",
        {
